...
// import { clearSessionData, contextComposer, MyContext } from './context'
...
//   // })
//
//   bot.command('addwords', async (ctx) => ctx.enterDialog('addWords'))
//
//   bot.on('message', (ctx, next) => ctx.handleDialogTextInput())
//   bot.use((ctx, next) => ctx.handleDialogUpdate())
//
